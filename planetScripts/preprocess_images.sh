...
${code_dir}/planetScripts/prePlanetImage.py ${output}_8bit_rgb.tif ${output}_8bit_rgb_sharpen.tif
...
# calculate NDVI
${code_dir}/planetScripts/planet_NDVI.py ${output}.tif ${output}_NDVI.tif

# calculate NDWI
${code_dir}/planetScripts/planet_NDWI.py ${output}.tif ${output}_NDWI.tif
