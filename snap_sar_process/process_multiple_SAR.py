...
def organize_sar_pairs_s1(sar_image_list, meta_data_path=None):
    ...
    for meta in sar_metas:
        if meta['properties']['fileName'] in file_name_list:
            ...
            basic.outputlogMessage('Warning, %s doesnt have a downloaded file' % meta['properties']['fileID'])
...
def multiple_SAR_coherence(sar_image_list,save_dir,res_meter, tmp_dir=None, ext_shp=None, dem_path=None,
                           cohWinAz=3,cohWinRg=10,thread_num=16,process_num=1):
